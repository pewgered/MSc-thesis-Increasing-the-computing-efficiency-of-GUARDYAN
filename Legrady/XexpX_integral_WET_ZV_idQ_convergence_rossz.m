...
for i_conv=1:N_conv_step
    ...
    SigmaMaj=SigmaS(1); % this is supposed to account for assuming a lack of a tight majorant at every phase space location
    ...
    ResIdeal;
    fprintf('Ideal = %f WET= %f relvarWET= %f\n', ResIdeal,ResWET(i_conv),VarWET(i_conv));
end
