function[Var]=qz_sphere_test2(n_SIRS,qz1)
...
for i=1:n_neutrons
    ...
    while alive && inside
        ...
        while r>0 && alive && inside
            ...
            ii=1;
            dist=((xyz_i(ii)+dir1(ii))*d_r-r_neutron(ii))/dir(ii);
            lat_i=1;
            for ii=2:3
                dist_temp=((xyz_i(ii)+dir1(ii))*d_r-r_neutron(ii))/dir(ii);
                if dist>dist_temp
                    dist=dist_temp;
                    lat_i=ii;
                end
            ...
            if xs>=dist
                ...
                xyz_i(lat_i)=xyz_i(lat_i)+dir1(lat_i)*2-1;
